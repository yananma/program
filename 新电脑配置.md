...
或者：`https://github.com/TGSAN/CMWTAT_Digital_Edition` 管理员权限运行。    



### 安装谷歌上网助手  

去百度网盘上下载，百度网盘路径是 软件/chrome扩展/nonmafimegllfoonjgplbabhmgfanaka-2.5.8  
...
（这个好像现在是出问题了，不能用了；这个方法是可以的，按照下面的教程操作；不行，操作是最后一步生成的激活码失效；可以用，激活码失效，也可以进软件）       
