...
打开联想应用商店 -> 设置中心 -> 壁纸设置 -> 屏保设置，取消开启勾选。     
...
手机双击屏幕不亮。解决的办法是关机重启：设置 -> 通用 -> 关机。唤醒的设置在：设置 -> 辅助功能 -> 触控 -> 轻点唤醒。但是按钮开着就行了，关了再开也没用，还是重启有用。     


电脑搜不到手机分享的 WiFi 热点：做了两件事情好了，但是不知道是因为哪个好的。第一就是打开隔空推送，所有人可以接收；第二就是点击通用 -> 还原 -> 还原网络设置。       
